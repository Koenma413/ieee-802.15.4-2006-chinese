...
　　如果您想参与翻译某一章节，请(通过 [pull request](contribution.md) 或者直接与我联系(QQ:1107953149))先将该章节的状态修改为“已领取，正在翻译...”，并将您的大名写在后面的贡献者里面。待翻译完了过后，请将状态改为“已完成”。
...
　　　　[5.3.1 星型网络](5/5.3.1 Star network formation.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.3.2 对等网络](5/5.3.2 Peer-to-peer network formation.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　[5.4 架构](5/5.4 Architecture.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.4.1 物理层 PHY](5/5.4.1 physical_layer_phy.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.4.2 MAC 子层](5/5.4.2 MAC sublayer.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　[5.5 功能概述](5/5.5 Functional overview.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.1 超帧结构](5/5.5.1 Superframe structure.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.2 数据传输模型](5/5.5.2 Data transfer model.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.3 帧结构](5/5.5.3 Frame structure.md)　|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.4 提高成功传输的概率](5/5.5.4 Improving probability of successful delivery.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.5 电源消耗](5/5.5.5 Power consumption considerations.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[5.5.6 安全](5/5.5.6 Security.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
　　[5.6 原语的概念](5/5.6 Concept of primitives.md)|已完成| [tidyjiang8](https://github.com/tidyjiang8)
...
　　[7.1 MAC 子层服务规范](7/7.1 MAC sublayer service specification.md)|已领取，正在翻译...| [tidyjiang8](https://github.com/tidyjiang8)
　　　　[7.1.1 MAC 数据服务](7/7.1.1 MAC data service.md)|已领取，正在翻译...| [tidyjiang8](https://github.com/tidyjiang8)
